...
#define CAL_ERROR 0.000001@// ŒvŽZŒë·


class PhysicalFeaturs {

public:
	bool isStatic;		// •s“®‚©‚Ç‚¤‚©. true‚É‚·‚é‚ÆŠO—Íid—ÍŠÜ‚Þj‚ðŽó‚¯‚È‚¢.

	float mass;			// d‚³[kg]
	float linearDrag;	// ˆÚ“®•ûŒü‚É‘Î‚·‚é‘¬“xŒ¸­ŒW”i‹ó‹C’ïR‚Å‚Í‚È‚¢j
	float angullarDrag;	// ‰ñ“]Žž‚Ì’ïR
...
public:
	...
	float staticFriction;	// Ã“I–€ŽCŒW” [0, 1]‚Ì”ÍˆÍ
	float dynamicFriction;	// “®“I–€ŽCŒW” [0, 1]‚Ì”ÍˆÍ
